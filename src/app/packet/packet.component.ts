...
import {
  PdfDisplayControlRenderer,
  PdfDisplayRendererTester,
} from '../pdf-viewer/pdf.renderer';
...
export class PacketComponent implements OnInit {
  renderers = [
    ...
    { tester: PdfDisplayRendererTester, renderer: PdfDisplayControlRenderer}
  ];
      ...
      this.conductor
        ...
        .then((maybeTask) => {
          ...
          if (maybeTask) {
            ...
            this.data = maybeTask.task!.input!;
          } else {
